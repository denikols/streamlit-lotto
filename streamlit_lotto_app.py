...
# Header personalizzato con HTML (tripla stringa)
st.markdown("""
<div class="header-container">
    <h2>Ricette</h2>
    <button class="btn-add" onclick="document.getElementById('hidden_submit').click()">+ Nuova</button>
</div>
""", unsafe_allow_html=True)

# Form nascosto per il pulsante "Nuova"
