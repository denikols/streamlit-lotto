...
def verifica_ambo(numeri_tecnica, dati_estrazione):
    ...
    # Per ogni ruota, controlla se ci sono almeno 2 numeri della tecnica
    for ruota, numeri in dati_estrazione.items():
    ...
    if df_lotto is not None and not df_lotto.empty:
        ...
        with col2:
            ...
            if not estrazione_visual_df.empty:
                ...
                # --- VERIFICA AMBO: Se ci sono numeri di tecnica calcolati, verifica se sono presenti nella stessa ruota ---
                ambo_trovato = False
                numeri_ambo = []
