...
st.set_page_config(
    ...
    layout="wide",  # Usa layout wide per sfruttare tutta la larghezza
)
...
# Layout a due colonne: selettore e tabella a sinistra, risultati a destra
...
with col1:
    ...
    # Mostra tutte le estrazioni nel CSV con scroll verticale
